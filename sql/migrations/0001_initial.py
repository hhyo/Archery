    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_type', models.CharField(choices=[('mysql', 'MySQL'), ('mssql', 'MsSQL'), ('redis', 'Redis'), ('pgsql', 'PgSQL'), ('oracle', 'Oracle'), ('mongo', 'Mongo'), ('phoenix', 'Phoenix'), ('inception', 'Inception'), ('goinception', 'goInception')], max_length=20, verbose_name='数据库类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pkey_path', mirage.fields.EncryptedCharField(blank=True, default='', max_length=300, null=True, verbose_name='密钥地址')),
