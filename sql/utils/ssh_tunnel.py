...
class SSHConnection(object):
    ...
    """
    def __init__(self, host, port, tun_host, tun_port, tun_user, tun_password, pkey_address, pkey_password):
        self.host = host
        self.port = int(port)
        ...
        if pkey_address != None and pkey_address != "":
            self.private_key = RSAKey.from_private_key_file(pkey_address, password=pkey_password)
