...
urlpatterns = [
    ...
    path(
        "v1/sqlquery/mq-jobs/",
        api_sqlquery.SQLQueryMqJobListCreateView.as_view(),
    ),
    path(
        "v1/sqlquery/mq-jobs/<str:job_id>/",
        api_sqlquery.SQLQueryMqJobDetailView.as_view(),
    ),
    path(
        "v1/sqlquery/mq-jobs/<str:job_id>/cancel/",
        api_sqlquery.SQLQueryMqJobCancelView.as_view(),
    ),
