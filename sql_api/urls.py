...
from . import api_user, api_instance, api_workflow, api_sqlquery, api_workflow_operations
...
urlpatterns = [
    ...
    path("v1/workflows/", api_workflow_operations.WorkflowListView.as_view()),
    path("v1/workflows/audit-list/", api_workflow_operations.WorkflowAuditListView.as_view()),
    path("v1/workflows/<int:workflow_id>/content/", api_workflow_operations.WorkflowContentView.as_view()),
    path("v1/workflows/<int:workflow_id>/rollback/", api_workflow_operations.WorkflowRollbackView.as_view()),
    path("v1/workflows/<int:workflow_id>/execution-window/", api_workflow_operations.WorkflowExecutionWindowView.as_view()),
    path("v1/workflows/<int:workflow_id>/approval/", api_workflow_operations.WorkflowApprovalView.as_view()),
    path("v1/workflows/<int:workflow_id>/execution/", api_workflow_operations.WorkflowExecutionView.as_view()),
    path("v1/workflows/<int:workflow_id>/schedule/", api_workflow_operations.WorkflowScheduleView.as_view()),
    path("v1/workflows/<int:workflow_id>/termination/", api_workflow_operations.WorkflowTerminationView.as_view()),
    path("v1/workflows/<int:workflow_id>/status/", api_workflow_operations.WorkflowStatusView.as_view()),
    path("v1/workflows/<int:workflow_id>/osc/", api_workflow_operations.WorkflowOscView.as_view()),
