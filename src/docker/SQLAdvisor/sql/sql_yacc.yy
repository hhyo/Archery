...
%type <NONE>
        query verb_clause create select do drop insert replace insert2
...
%type <spcondvalue> sp_cond sp_hcond sqlstate
...
spatial_type:
          GEOMETRY_SYM        { $$= GEOM_GEOMETRY; }
        | GEOMETRYCOLLECTION  { $$= GEOM_GEOMETRYCOLLECTION; }
        | POINT_SYM
          {
...
assign_to_keycache:
          ...
          {
            if (!Select->add_table_to_list(YYTHD, $1, NULL, 0,
...
preload_keys:
          ...
          {
            if (!Select->add_table_to_list(YYTHD, $1, NULL, $3,
                                           Select->pop_index_hints()))
              MYSQL_YYABORT;
          }
        ;
...
preload_keys_parts:
          ...
          {
            if (!Select->add_table_to_list(YYTHD, $1, NULL, $4,
                                           Select->pop_index_hints()))
              MYSQL_YYABORT;
          }
        ;
...
table_lock:
          table_ident opt_table_alias lock_option
          {
            ...
            if (!Select->add_table_to_list(YYTHD, $1, $2, 0))
              MYSQL_YYABORT;
          }
        ;
