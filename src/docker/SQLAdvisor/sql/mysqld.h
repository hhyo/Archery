...
extern bool opt_error_log;
extern my_bool opt_log, opt_log_raw;
...
extern uint opt_mts_checkpoint_period, opt_mts_checkpoint_group;
...
extern PSI_mutex_key
  ...
  key_LOCK_lock_db, key_LOCK_logger,
...
extern PSI_file_key key_file_casetest,
...
extern int mysqld_init(char *arg_mysql_home);
extern LEX * sql_parser(char *query, char *default_db);
extern int sql_parser_cleanup();
extern int mysqld_cleanup();
